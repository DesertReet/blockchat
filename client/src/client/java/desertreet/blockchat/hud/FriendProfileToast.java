 ...
 */
public final class FriendProfileToast implements Toast {
	...
	public void render(GuiGraphics graphics, Font font, long fullyVisibleFor) {
		graphics.blitSprite(RenderPipelines.GUI_TEXTURED, BACKGROUND_SPRITE, 0, 0, TOAST_WIDTH, TOAST_HEIGHT);
	...
	private void renderIcon(GuiGraphics graphics, Font font) {
		...
		graphics.blit(RenderPipelines.GUI_TEXTURED, faceTexture, ICON_X, ICON_Y, 0, 0, FACE_SIZE, FACE_SIZE, FACE_SIZE, FACE_SIZE);
	}
