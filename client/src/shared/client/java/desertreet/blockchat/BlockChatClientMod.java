...
import desertreet.blockchat.compat.BlockChatKeyMappings;
import desertreet.blockchat.compat.BlockChatScreenshotCompat;
...
public final class BlockChatClientMod implements ClientModInitializer {
	...
	private static final Object KEY_CATEGORY = BlockChatKeyMappings.createCategory("desertreet", "blockchat");
	...
	public void onInitializeClient() {
		...
		openKey = BlockChatKeyMappings.register(BlockChatKeyMappings.create(
			"key.blockchat.open",
		...
		recordKey = BlockChatKeyMappings.register(BlockChatKeyMappings.create(
	...
	private static void onEndClientTick(Minecraft client) {
		...
		BlockChatHud.tick();
		BlockChatScreenshotCompat.triggerUnhandledScreenshotIfNeeded(client);
