/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 315ed379a2d77682aaa6b1310ffd158d)
// Runtime types generated with workerd@1.20260317.1 2026-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BlockChatUserDurableObject";
	}
	interface TestEnv {
		SNAPS_BUCKET: R2Bucket;
		...
		MS_CLIENT_ID: string;
		MS_TENANT_ID: string;
		USER_DO: DurableObjectNamespace<import("./src/index").BlockChatUserDurableObject>;
	}
	interface Env {
		SNAPS_BUCKET: R2Bucket;
		R2_ACCESS_KEY_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "TEST_MODE" | "MS_CLIENT_ID" | "MS_TENANT_ID">> {}
}
